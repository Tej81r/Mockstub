...
exports.ChaincodeMockStub = void 0;
var queryEngine = __importStar(require("@theledger/couchdb-query-engine"));
...
var ChaincodeMockStub = /** @class */ (function () {
    ...
    ChaincodeMockStub.prototype.mockTransactionStart = function (txid, transientMap) {
        ...
        this.setTxTimestamp(this.txTimestamp);
    ...
    ChaincodeMockStub.prototype.getStateByRange = function (startKey, endKey) {
        ...
        var items = Object.keys(this.state)
            ...
            .map(function (k) { return new mockKeyValue_1.MockKeyValue(k, _this.state[k], "ac"); });
        return;
    ...
    ChaincodeMockStub.prototype.getStateByRangeWithPagination = function (startKey, endKey, pageSize, bookmark) {
        try {
            var iterator = this.getStateByRange(startKey, endKey);
            return;
    ...
    ChaincodeMockStub.prototype.getMspID = function () {
        return this.mspId;
    };
    /**
     *
    ...
    ChaincodeMockStub.prototype.getQueryResult = function (query) {
        ...
        var items = queryEngine.parseQuery(keyValues, parsedQuery)
            .map(function (item) { return new mockKeyValue_1.MockKeyValue(item.key, datatransform_1.Transform.serialize(item.value), "ac"); });
        return;
        //return Promise.resolve(new MockStateQueryIterator(items, this.txID));
    };
    // tslint:disable-next-line:max-line-length
    ChaincodeMockStub.prototype.getQueryResultWithPagination = function (query, pageSize, bookmark) {
        try {
            var iterator = this.getQueryResult(query);
            return;
    ...
    ChaincodeMockStub.prototype.getStateByPartialCompositeKeyWithPagination = function (objectType, attributes, pageSize, bookmark) {
        try {
            var iterator = this.getStateByPartialCompositeKey(objectType, attributes);
            return;
            //return this.paginate(iterator, pageSize, bookmark);
        }
        catch (err) {
    ...
    ChaincodeMockStub.prototype.getPrivateDataByRange = function (collection, startKey, endKey) {
        ...
        var items = Object.keys(privateCollection)
            ...
            .map(function (k) { return new mockKeyValue_1.MockKeyValue(k, privateCollection[k], "ac"); });
        return;
        //return Promise.resolve(new MockStateQueryIterator(items, this.txID));
    };
    /**
